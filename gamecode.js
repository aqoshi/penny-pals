...
function colorBox(x)
{
                        ...
                        var coinImg = document.createElement("img"); // Create a new img element
                        coinImg.style.height = '100%'; // Set the image height to fill the box
                        coinImg.style.width = '100%'; // Set the image width to fill the box
                    
                        if(p == 1){
                            coinImg.src = 'images/1coin.png'; // Set the source of 1 coin image
                        } else if(p == 2){
                            coinImg.src = 'images/10coin.png'; // Set the source of 10 coin image
                        } // Add more conditions if you have more images
                    
                        // Remove any existing children (to prevent multiple images in one box)
